      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-blue shadow-sm relative z-10 flex items-center justify-between px-6 py-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-36 border rounded-lg shadow-lg bg-gray-200">
                <button
                  onClick={handleLogout}
                  className="block w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-300 rounded-md"
                >
                  Logout
                </button>
              </div>
